...
import org.d3if3001.assessment2.navigation.Screen
import org.d3if3001.assessment2.util.SettingsDataStore
...
@Composable
fun ListItem(sepatu: Sepatu, onClick: () -> Unit){
    Column (
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() }
...
//        Text(text = mahasiswa.id.toString())
        Text(text = sepatu.nama, maxLines = 1, overflow = TextOverflow.Ellipsis, fontWeight = FontWeight.Bold)
        Text(text = "Ukuran : "+sepatu.ukuran.toString(), maxLines = 1, overflow = TextOverflow.Ellipsis)
        Text(text = "Wilayah : "+sepatu.wilayah)
    }
}
@Composable
fun GridItem(sepatu: Sepatu, onClick: () -> Unit){
    Card (
        modifier = Modifier
            .fillMaxWidth()
            .clickable { onClick() },
        ...
        Column(
            ...
            Text(
                text = "Ukuran : " + sepatu.ukuran.toString(),
                maxLines = 1,
                overflow = TextOverflow.Ellipsis,
            )
            Text(
                text = "Wilayah : " + sepatu.wilayah,
                maxLines = 1,
                overflow = TextOverflow.Ellipsis
            )
        }
